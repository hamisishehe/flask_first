...
class Course(db.Model):
    ...
    instructors = db.relationship(
        "Instructor", secondary=instructor_course, backref="courses"
    )
...
class Department(db.Model):
    ...
    students = db.relationship("Students", back_populates="department", lazy=True)
...
class User(db.Model):
    ...
    courses = db.relationship(
        "Course", backref="coordinator", lazy=True
    )  # Added relationship
